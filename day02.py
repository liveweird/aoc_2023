...
def day02_part2(input_file: str) -> int:
    # open the input file
    f: typing.TextIO = open(input_file, "r")
    result: int = 0
    ...
    for line in f:
        ...
        result += max_used_red * max_used_green * max_used_blue
...
def test_day02_part2a():
    assert day02_part2("./input/day02a.txt") == 2286

def test_day02_part2b():
    assert day02_part2("./input/day02b.txt") == 49710